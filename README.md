...
- **Credentials & Achievements:** Includes BCA Degree (St. Aloysius University), IBM Data Science Professional Cert, Deloitte Virtual Experience, Introduction to Generative AI Studio, Data Formats for Data Engineering, Class Representative badge, and National Kung-Fu Bronze Medalist badge.
- **Glassmorphic UI Design:** Dark mode theme (`#050811`) with Electric Cyan (`#00F0FF`) & Neon Indigo (`#6366F1`) accents, 60fps HTML5 canvas particle background, and responsive mobile drawer.
- **One-Click Resume Download:** Includes direct download of official resume PDF.
